...
#filename = 'dataview.log'
#printeachline(filename)
#Y = readfromfile(filename)
#print(Y)

#filename = '0_mapping_events.txt'
#temp_dict = readDictFromFile(filename)
#print(temp_dict)

#filename = 'x_t3_mapping.txt'
#d = readDictWithList(filename)
#print d
